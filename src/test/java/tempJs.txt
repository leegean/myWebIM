!window.WBtopGlobal_loginLayer && (window.WBtopGlobal_loginLayer = function() {
    ...
    (function() {
        ...
        a.register("core.util.URL", function(a) {
            return function(c, d) {
                var e = a.core.obj.parseParam({isEncodeQuery: !1,isEncodeHash: !1}, d || {}), f = {}, g = a.core.str.parseURL(c), h = a.core.json.queryToJson(g.query), i = a.core.json.queryToJson(g.hash);
        ...
        a.register("core.io.jsonp", function(a) {
            return function(c) {
                var d = a.core.obj.parseParam({url: "",charset: "UTF-8",timeout: 3e4,args: {},onComplete: null,onTimeout: null,responseName: null,isEncode: !1,varkey: "callback"}, c), e = -1, f = d.responseName || "STK_" + a.core.util.getUniqueKey();
                d.args[d.varkey] = f;
        ...
        (function() {
            var b = a.core, c = {removeNode: b.dom.removeNode,bind: b.func.bind,empty: b.func.empty,addEvent: b.evt.addEvent,removeEvent: b.evt.removeEvent,parseParam: b.obj.parseParam,merge: b.json.merge,str2Json: b.json.strToJson,json2Str: b.json.jsonToStr,jsonp: b.io.jsonp,scriptLoader: b.io.scriptLoader};
            for (var d in c)
                ...
                return {register: function(b, c, d) {
                        ...
                        if (a[c] && a[c][g] && a[c][g].length > 0) {
                            ...
                            for (j = 0, k = i.length; j < k; j++)
                                b.push({channel: c,evt: g,func: i[j],data: h});
                            d()
                        }
                    },remove: function(b, c, d) {
                        if (a[b] && a[b][c])
        ...
        a.register("comp.plugin", function(a) {
            ...
            e.canPostMessage = !1;
            var f = {iframeUrl: "http://login.sina.com.cn/plugin_proxy.html",proxyUrl: "",getinfos_timeout: 1e4,getticket_timeout: 1e4,entry: "sso",domain: "weibo.com",savestate: "30",crossdomain_timeout: 1e4,login_request_timeout: 1e4};
            d.init = function(c) {
                f = a.merge(f, c);
                e.canPostMessage = !e.isIE() || e.isIE() && e.isIE() > 8;
                if (!e.canPostMessage && !f.proxyUrl)
                    b.fire("getinfo_error", {code: "-3",msg: "br can't support postMessage, please provide proxy html"});
                else {
            ...
            e.login = function(c) {
                if (!!c) {
                    ...
                    a.jsonp({url: "//login.sina.com.cn/sso/login.php",timeout: f.login_request_timeout,args: {entry: f.entry,returntype: "TEXT",crossdomain: 1,cdult: 3,domain: f.domain,alt: i,savestate: f.savestate},onComplete: function(a) {
                            a.retcode != 0 ? b.fire("login_failure", {code: a.retcode,msg: a.reason}) : e.crossdomain(a, function(c) {
                                c.result === !1 ? b.fire("login_failure", {code: -2,msg: "登录失败"}) : b.fire("login_success", a)
                            })
                        },onTimeout: function() {
                            b.fire("login_failure", {code: -1,msg: "登录超时"})
                        },isEncode: !0,varkey: "callback"})
                }
            };
            e.crossdomain = function(b, c) {
                ...
                if (d == 0)
                    ...
                    for (var g in b.crossDomainUrlList)
                        a.scriptLoader({url: b.crossDomainUrlList[g],charset: "UTF-8",args: {action: "login"},onComplete: function() {
                                d--;
                                if (d == 0) {
                                    clearTimeout(e);
                                    c({result: !0})
    ...
    STK.register("v6.pub.plugin.sso.desktopbridge", function(a) {
        var b = window.SINA_USER_PLUGIN, c = a.v6.conf.channel.sso.desktop;
        return function(a) {
            var d = !1, e = {init: function() {
                    if (!d) {
                        e.bind();
                        d = !0
                    }
                    ...
                    for (var a in e.handle)
                ...
                },send: {getuserinfo_ready: function(a) {
                        ...
                        b.init({iframeUrl: "http://login.sina.com.cn/plugin_proxy.html",proxyUrl: "http://weibo.com/sso/desktopcallback",getinfos_timeout: 5e3,getticket_timeout: 5e3})
                    },login: function(a) {
                        b.login(a)
                    }}}, f = {};
            e.init();
    ...
    function SSOController() {
        ...
        (function() {
            var a = function() {
            }, b = {username: "",password: "",savestate: 0,vsnf: 0,vsnval: "",door: "",setCookie: 1,ssoSimpleLogin: 0,onComplete: a,onSuccess: a,onFailure: a}, c = {onComplete: a,onSuccess: a,onFailure: a}, d = {vsnf: "vsnf",vsnval: "vsnval",door: "door",setCookie: "s",ssoSimpleLogin: "ssosimplelogin"}, e = {}, f = {}, g = function(a, b) {
                var c, d = {};
                a = a || {};
                b = b || {};
                objMerge(d, a);
            ...
            customPrepare = function(a) {
                var c;
                a = a || {};
                e = objMerge({entry: "sso",useTicket: !1,service: "sso",domain: "sina.com.cn",feedBackUrl: "",setDomain: !1,crossDomain: !0,name: "sinaSSOController"}, b);
                e = g(e, a);
        ...
        this.login = function(a, b, c) {
            ...
            ssoLoginTimer.start(me.loginTimeout, function() {
                ssoLoginTimer.clear();
                me.callbackLoginStatus({result: !1,errno: -1,reason: unescape("%u767B%u5F55%u8D85%u65F6%uFF0C%u8BF7%u91CD%u8BD5")})
            });
            c = c == undefined ? 0 : c;
            tmpData.savestate = c;
            loginByConfig = function() {
                if (!me.feedBackUrl && loginByXMLHttpRequest(a, b, c))
                    return !0;
        ...
        this.crossDomainAction = function(a, b) {
            ...
            var d = {scriptId: me.ssoCrossDomainScriptId,callback: me.name + ".crossDomainCallBack",action: a,domain: c,sr: window.screen.width + "*" + window.screen.height}, e = makeURL(ssoCrosssDomainUrl, d);
        ...
        this.appLogin = function(a, b, c) {
            var d = tmpData.savestate ? parseInt((new Date).getTime() / 1e3 + tmpData.savestate * 86400) : 0, e = getCookie("ALF") ? getCookie("ALF") : 0, f = {callback: c,ticket: a,ssosavestate: d || e}, g = me.appLoginURL[b], h = makeURL(g, f);
        ...
        var makeNonce = function(a) {
            ...
            var b = {entry: me.getEntry(),service: me.service,encoding: "UTF-8",gateway: 1,returntype: "TEXT",from: me.from};
            if (me.domain == "sina.com.cn") {
            ...
            return objMerge(e, {encoding: "UTF-8",cdult: d,domain: me.domain,useticket: me.appLoginURL[me.domain] ? 1 : 0,prelt: preloginTime,returntype: "TEXT"})
            ...
            for (var f in me.loginExtraQuery) {
                if (typeof me.loginExtraQuery[f] == "function")
                    continue;
    ...
    STK.register("v6.pub.plugin.sso.loginbridge", function(a) {
        var b = window.sinaSSOController, c = a.v6.conf.channel.sso.login, d = {savestate: 0,vsnf: 0,hold_login_state: !1,cookie_timeout: 0,extraTypes: ["verifycode", "vsncode"],extraConf: {verifycode: [1, 4049, 2070],vsncode: [2, 5024, 5025],password: [80]}}, e = {entry: "sinaoauth",domain: "sina.com.cn",service: "sinaoauth",useTicket: !0,crossDomain: !1,feedBackUrl: ""}, f = !1;
        return function(g) {
            var h = {param: {},extra: !1}, i = {init: function() {
                    if (!f) {
                        i.setOptions(g);
                        i.bind();
                        i.getUniqueKey();
    ...
    (function() {
        ...
        a.register("jobs.qrcode_login", function(a) {
            var b = {}, c = a.common.channel.qrcode_login, d = {entry: "sso",domain: "weibo.com",get_image_timeout: 1e4,check_request_timeout: 1e4,qrcode_size: 180,crossdomain_timeout: 3e3,savestate: 30}, e = {qrcode_image: "//login.sina.com.cn/sso/qrcode/image",qrcode_check: "//login.sina.com.cn/sso/qrcode/check",qrcode_login: "//login.sina.com.cn/sso/login.php"}, f, g = 0, h = 3e3, i;
            b.set = function(a) {
                for (var c in a)
                    d[c] = a[c];
                return b
            ...
            var j = function(g) {
                a.core.io.jsonp({url: e.qrcode_image,timeout: d.get_image_timeout,args: {entry: d.entry,size: d.qrcode_size},onComplete: function(a) {
                        if (!a || a.retcode != 2e7)
                            g(a);
                        else {
                            var b = a.data;
                ...
                a.core.io.jsonp({url: e.qrcode_check,timeout: d.check_request_timeout,args: {entry: d.entry,qrid: f},onComplete: function(a) {
                        a ? b(a) : b({retcode: -1})
                    },onTimeout: function() {
                        c.fire("check_timeout")
                    },isEncode: !0,varkey: "callback"})
            }, m = function(b) {
                a.core.io.jsonp({url: e.qrcode_login,timeout: d.login_request_timeout,args: {entry: d.entry,returntype: "TEXT",crossdomain: 1,cdult: 3,domain: d.domain,alt: b.data.alt,savestate: d.savestate},onComplete: function(a) {
                        a.retcode != 0 ? c.fire("login_failure", {retcode: a.retcode,msg: a.reason}) : n(a, function(b) {
                            b.result === !1 ? c.fire("login_failure", {retcode: -2,msg: "登录失败"}) : c.fire("login_success", a)
                        })
                    },onTimeout: function() {
                        c.fire("login_failure", {retcode: -1,msg: "登录超时"})
                    },isEncode: !0,varkey: "callback"})
            }, n = function(b, c) {
                ...
                if (e == 0)
                    ...
                    for (var g in b.crossDomainUrlList)
                        a.core.io.scriptLoader({url: b.crossDomainUrlList[g],charset: "UTF-8",args: {action: "login"},onComplete: function() {
                                e--;
                                if (e == 0) {
                                    clearTimeout(f);
                                    c({result: !0})
    ...
    STK.register("v6.pub.plugin.sso.qrcodebridge", function(a) {
        var b = window.SINA_QRCODE_LOGIN, c = a.v6.conf.channel.sso.qrcode;
        return function(a) {
            var d = !1, e = {init: function() {
                    if (!d) {
                        e.bind();
                ...
                },send: {qrcode_scanned: function(a) {
    ...
    STK.register("v6.pl.open.loginlayer.source.pluginloader", function(a) {
        var b = !1;
        return function(c) {
            var d = {desktop: !1,login: !1,qrcode: !1}, e = {vsnf: 1,hold_login_state: !1,cookie_timeout: 0,entry: "weibo",domain: "weibo.com",service: "miniblog",useTicket: !0,crossDomain: !0,feedBackUrl: $CONFIG && $CONFIG.loginFeedBackUrl ? $CONFIG.loginFeedBackUrl : "http://" + window.location.hostname + "/ajaxlogin.php",loginSuccessUrl: ""}, f = {init: function() {
                    if (!b) {
                        b = !0;
                        f.parseParam();
                        f.initPlugin()
    ...
    STK.register("v6.lib.kit.extra.cssPath", function(a) {
        var b = {path: $CONFIG.cssPath || "http://img.t.sinajs.cn/t6/",mPath: $CONFIG.mCssPath}, c, d = function() {
            c = [""];
            for (var a = b.mPath[1]; a <= b.mPath[2]; a++)
                c.push(a.toString())
        }, e = function() {
    ...
    STK.register("v6.pub.ui.tipAlert", function(a) {
        return function(b) {
            var c, d = '<div class="Bv6_layer Bv6_layer_pop">\n\t<div class="content layer_mini_info">\n\t\t<p class="main_txt">\n\t\t\t<span node-type="icon"></span>\n\t\t\t<span node-type="text"></span>\n\t\t</p>\n\t\t<div node-type="otherText"></div>\n\t\t\n\t\t<div class="W_layer_arrow">\n\t\t\t<span node-type="arrow" class="W_arrow_bor"><i class="S_line3"></i><em class="S_bg2_br"></em></span>\n\t\t<div>\n\t</div>\n</div>', e = {init: function() {
                    ...
                    e = a.parseParam({el: null,box: null,icon: null,offsetX: 0,offsetY: 0,useNewTemplate: !0,pos: null}, e || {});
                    if (!!e.el && !!a.isNode(e.el)) {
                        a.isNode(e.box) || (e.box = e.el);
                        e.icon in a.v6.conf.data.iconType || (e.icon = "rederrorS");
                        e.autoHide = !!e.autoHide;
                        var f = {icon: e.icon,autoHide: e.autoHide,stopClickPropagation: !1,showWithSetWidth: !1};
                        e.useNewTemplate && (f.template = d);
                        var g = {offsetX: e.offsetX,offsetY: e.offsetY || 5};
                        e.pos && (g.pos = e.pos);
                    ...
                    c && c.destroy();
                    c = null
                }}, f = {layer: c,show: e.show,hide: e.hide,destroy: e.destroy};
            return f
        }
    });
    ...
    STK.register("common.layer.emailAutocomplete", function(a) {
        var b = a.kit.extra.textareaUtils, c = a.kit.extra.language, d = ["sina.com", "163.com", "qq.com", "126.com", "vip.sina.com", "sina.cn", "hotmail.com", "gmail.com", "sohu.com", "139.com", "wo.com.cn", "189.cn", "21cn.com"], e = {panel: ['<div node-type="layer" class="layer_menu_list" style="display:none;">', '<ul><li class="note">#L{请选择邮箱类型}</li></ul>', '<ul node-type="panel"></ul>', "</div>"].join(""),item: ["<#et userlist data>", "<#list data.data as item>", '<li action-type="item" action-data="value=${data.key}@${item}" ><a href="#">${data.key}@${item}</a></li>', "</#list>", "</#et>"].join("")}, f = ["enter", "esc", "up", "down"], g = [/^[0-9a-z_][_.0-9a-z-]{0,31}$/, /^[0-9a-zA-Z_][_.0-9a-zA-Z-]{0,31}$/], h = {};
        return function(b, i) {
            var j, k, l, m, n, o, p, q = !1, r = {get: function(a) {
                    ...
                    l.innerHTML = a.core.util.easyTemplate(j.template.item, {key: encodeURIComponent(b),domain: c,data: d}).toString();
                    s = null
                ...
                }}, w = {mousedown: {item: function(a) {
                        b.value = a.data.value
                    }},click: {item: function(b) {
                        a.preventDefault();
                        x.hide()
                    }}}, x = {init: function() {
                    if (!a.isNode(b))
    ...
    STK.register("v6.pub.form.rule", function(a) {
        var b = a.v6.lib.kit.extra.orderStr, c = {};
    ...
    STK.register("v6.pub.form.textCopy", function(a) {
        var b = a.v6.pub.form.rule, c = a.core.dom.uniqueID, d = {text: "text"}, e = function(a) {
            var b = [];
            for (var c in a)
                b.push(a[c]);
            return b
        ...
        return function(e, f) {
            var g, h = {blur: function(b) {
                ...
                m.buildItem(a);
                m.active(a.el)
            }, k = {}, l = {click: j,focusin: j}, m = {init: function() {
                    m.parseParam();
                    m.bind()
                },parseParam: function() {
                    ...
                    i.text.place(b);
                    a.custEvent.fire(o, "focus", {type: options.actionType,el: b});
                    var c = b.getAttribute("no_cls");
                    c != "true" && a.addClassName(b, options.focusCS)
                }}, n = {isCopyText: function(b) {
    ...
    STK.register("common.setting.form", function(a) {
        ...
        return function(c, d) {
            var e = {}, f, g = "form", h = {ctls: {},states: {}}, i = {reset: function(a) {
                    for (var b in a)
                        h.states[b] = a[b]
                }}, j = {init: function() {
                    j.pars();
    ...
    STK.register("common.setting.dataType", function(a) {
        var b = a.kit.extra.language, c = {msg: {id: "",state: !0,type: "empty",code: "",action: "",msg: "",iodata: null,iorecords: !1},initPars: {text: "",hook: null,type: "",proxy: null,iokey: null,disabled: !1,iodelay: 0,must: !0,auto: !0},errText: {E00: b("#L{系统繁忙}")}}, d = {};
        d.get = function(b) {
    ...
    STK.register("common.setting.vsncode", function(a) {
        var b = {E01: "",E02: "#L{请输入微盾动态码}",E03: "#L{动态码有误，请重新输入}"};
        return function(c, d) {
            var e = function() {
                var a = g.value().replace(/^\s+|\s+$/g, ""), b = !1;
                if (!g.pars.must && g.rule.isEmpty(a)) {
    ...
    STK.register("common.setting.username", function(a) {
        var b = {E01: "",E02: "#L{请输入登录名}",E03: "#L{请输入正确的登录名}"};
        return function(c, d) {
            var e, f = function() {
                var a = h.value(), b = !1;
    ...
    STK.register("common.setting.passwordlite", function(a) {
        var b = {E01: "",E02: "#L{请输入密码}",E03: "#L{请输入正确的密码}"}, c;
        return function(d, e) {
            var f = function() {
                var a = j.value(), b = !1;
            ...
            }, g = a.core.dom.next(d), h = {init: function() {
                    h.auto()
                },auto: function() {
    ...
    STK.register("v6.pub.login.form", function(a) {
        var b = ["username", "password", "verifycode", "vsncode"], c = a.core.util.templet, d = a.v6.conf.channel.sso.login, e = a.v6.pub.form.verifycodeSSO, f = a.core.evt.hotKey, g = a.kit.extra.textareaUtils, h = $CONFIG && $CONFIG.register_url || "http://weibo.com/signup/signup.php" + (Boolean(a.URL(window.location.href).getParam("c")) ? "?backurl=" + encodeURI(window.location.href) : ""), i = {CAPSLOCK: "#L{键盘大写锁定已打开，请注意}",ERRTIP: {CODE: a.common.form.ssoErrCode},SAVE_STATE_LAYER: '<div class="layer_pop" node-type="outer" style="position:absolute;"><p node-type="content"></p></div>',MAIN: '<div node-type="prename_box" class="info_list pre_info clearfix"></div><div node-type="username_box" class="info_list"><div class="inp username"><input autocomplete="off" maxlength="128" tabindex="1" node-type="username" name="username" type="text" class="W_input" action-type="text_copy" action-data="text=#L{邮箱/会员帐号/手机号}" value="" /></div></div><div node-type="password_box" class="info_list"><div class="inp password"><input maxlength="24" tabindex="2" node-type="password" name="password" type="password" class="W_input" action-type="text_copy" value="" /><span class="enter_psw">#L{请输入密码}</span></div></div><div node-type="verifycode_box" class="info_list" style="display: none;"><div class="inp verify"><input maxlength="6" tabindex="3" node-type="verifycode" name="verifycode" type="text" class="W_input" value="" action-type="text_copy" action-data="text=#L{验证码}" /><a class="code" href="javascript:void(0);" onclick="return false;"><img src="" node-type="verifycode_image" action-type="btn_change_verifycode" width="100" height="40"></a><a node-type="btn_change_verifycode" action-type="btn_change_verifycode" class="verify_refresh" href="javascript:void(0);" onclick="return false;">#L{换一换}</a></div></div><div node-type="vsncode_box" class="info_list" style="display: none;"><div class="inp wei_dun"><input maxlength="6" tabindex="4" node-type="vsncode" name="vsncode" type="text" class="W_input" action-type="text_copy" action-data="text=#L{请输入微盾动态码}" value="" /><a node-type="btn_vsncode_recover" href="http://account.weibo.com/forgot/vdun">#L{微盾挂失}</a></div></div><div class="info_list"><div class="inp automatic clearfix"><div class="right"><a suda-data="key=tblog_weibologin3&value=click_forgetpwd" target="_blank" node-type="btn_password_recover" href="https://login.sina.com.cn/getpass.html?entry=weibo">#L{忘记密码}</a></div><label action-type="customTip" action-data="content=#L{建议在网吧或公共电脑上取消该选项。}" title="#L{建议在网吧或公共电脑上取消该选项。}" for="login_form_savestate"><input tabindex="5" id="login_form_savestate" checked="checked" node-type="savestate" type="checkbox" class="W_checkbox" />#L{下次自动登录}</label><a suda-data="key=tblog_weibologin3&value=click_help" action-type="customTip" action-data="content=#L{记不住登录状态，怎么办？}" title="#L{记不住登录状态，怎么办？}" target="_blank" class="icon_ask" href="http://help.weibo.com/faq/q/85/12524#12524"></a></div></div><div class="info_list no_reg"><a tabindex="6" suda-data="key=tblog_weibologin3&value=click_sign" node-type="submitBtn" action-type="btn_submit" class="W_btn_g" href="javascript:void(0)"><span node-type="submitStates">#L{登录}</span></a></div>',SUBMIT: {NORMAL: "<em>#L{登录}</em>",ONSUBMIT: '<i class="W_loading"></i><em>#L{登录}</em>'},PRENAME_BOX: '<div class="W_tips tips_warn clearfix" action-type="closeTip"><p class="icon"><span class="W_icon icon_warnS"></span></p><p class="txt">为了您的安全，请确认登录</p></div><div class="item user_card clearfix"><div class="img_wrap W_fl"><img width="50" height="50" class="W_face_radius" src="#{AVATAR}"></div><div class="account W_fl"><p class="account_name W_autocut S_txt1">#{LOGIN_NAME_HAZY}</p><a href="javascript:void(0)" action-type="use_username">#L{换个账号登录}</a></div></div>'}, j = {panel: ['<div node-type="layer" class="Bv6_layer_menu_list" style="display:none;">', '<ul><li class="note">#L{请选择邮箱类型}</li></ul>', '<ul node-type="panel"></ul>', "</div>"].join(""),item: ["<#et userlist data>", "<#list data.data as item>", '<li action-type="item" action-data="value=${data.key}@${item}" ><a href="#">${data.key}@${item}</a></li>', "</#list>", "</#et>"].join("")}, k = {username: a.common.setting.username,password: a.common.setting.passwordlite,verifycode: a.common.setting.verifycode,vsncode: a.common.setting.vsncode}, l = function() {
            ...
            return b
        }(), m = {cookie: {name: "un",conf: {expire: 240,path: "/",domain: window.location.hostname,encode: !0}},verifyCodeDelay: 3e5,savestateDelay: 600,errtipDelay: 5e3}, n, o = function(b) {
            if (!n) {
                n = [];
        ...
        return function(f, h) {
            var n, p, q, r, s = {}, t, u, v, w = {yalogin: !1,nopwd: !1,unChecked: !1}, x = {init: function() {
                    x.parseParam();
                    x.parseDOM();
                    x.initPlugin();
                    x.bind()
                    ...
                    C.vsncode.disable();
                    u = a.common.layer.emailAutocomplete(q.username, {autoTrim: !0,autoCase: !0,offsetX: -35,offsetY: 4,width: a.core.dom.getSize(q.username.parentNode).width - 4,template: j});
                    ...
                    p.add(b, k[b](q[b], a.core.json.merge({hook: p}, _data)));
                    a.core.util.browser.MOZ && r.API.build({el: q[b],data: _data})
                    ...
                    }},customTip: {show: function(a) {
                        customTip.show(a.el, a.data.content)
                    },hide: function() {
                        customTip.hide()
                    }},reset: function() {
                    y.errTip.hide()
                },submit: {active: function() {
                        s.checkUsername && clearTimeout(s.checkUsername);
                        a.preventDefault();
                        y.errTip.hide();
                        u.hide();
                    ...
                    if (b.keyCode === 13) {
                        if (u.onActive())
                            return;
                        p.check();
                        var c = p.states(), d = b.target.getAttribute("node-type");
                        if (d == "password" && w.nopwd) {
                            y.errTip.show({username: {state: !1,msg: i.ERRTIP.CODE[4098]}});
                            return
                        }
                    ...
                    (c >= 65 && c <= 90 && !d || c >= 97 && c <= 122 && d) && y.errTip.show({password: {msg: i.CAPSLOCK}})
                }}, B = {login: {complete: function() {
                        y.unlock();
                        y.submit.stop()
                    },success: function(a) {
                        y.remember.mark();
                        ...
                        var b;
                        a.code == "50113021" && y.usernameBox();
                        o(a.code) ? b = c(i.ERRTIP.CODE["" + a.code], {USERNAME: p.ctls.username.value()}) : b = !a.reason || a.reason === "" ? i.ERRTIP.CODE[9999] + "(" + a.code + ")" : a.reason;
                        var d = {};
                        d[a.type] = {msg: b,state: !1};
                        y.errTip.show(d, 1)
                    }},logout: {complete: function() {
                    },success: function() {
                    },failure: function() {
                    }},verify: {complete: function(a) {
                        y.unlock();
                        ...
                        y.changeExtra(a);
                        q[a].value = ""
                    }},yalogin: {active: function(b) {
                        var d = !1, e = setTimeout(function() {
                            d = !0;
                            y.usernameBox()
                        }, 2500);
                        a.kit.io.jsonp({url: "http://" + (window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com") + "/a/aj/prelogin/status",onComplete: function(f) {
                                if (!d) {
                                    e && clearTimeout(e);
                                    if (f.code == "100000") {
                                        var g = f.data;
                                        if (g.uid == b) {
                                            q.prename_box.innerHTML = c(i.PRENAME_BOX, {AVATAR: g.avatar,LOGIN_NAME_HAZY: g.account,NICKNAME: g.nickname});
                                            w.yalogin = g.uid;
    ...
    STK.register("v6.pub.login.qrcode", function(a) {
        return function(b, c) {
            var d, e, f, g, h = a.kit.extra.language, i = a.v6.conf.channel.sso.qrcode, j = !0, k = {scanSucc: h('<div node-type="outer" style="width:208px" class="layer_form_tips"><div class="bg"><div node-type="inner" class="content qrcode_tips"><a class="W_ico12 icon_close" node-type="close"></a><div class="W_tips empty clearfix"><p class="icon"><span class="icon_succ"></span></p><p class="txt">#L{扫描成功}！<br>#L{点击手机上的确认即可登录}</p></div></div><div class="arrow arrow_tips"></div></div>')}, l = {init: function() {
                    i.fire("set", {entry: "weibo",domain: "weibo.com"});
                    c = c || {};
                    l.parseDOM();
                    c.isLayer || l.initPlugins();
                    l.bind()
                },parseDOM: function() {
                    d = a.kit.dom.parseDOM(a.builder(b).list)
                },bind: function() {
                    a.addEvent(d.qrcode_src, "mouseover", l.tips.show);
                    a.addEvent(d.qrcode_src, "mouseout", l.tips.hide);
                    for (var c in l.handle)
                        i.register(c, l.handle[c]);
                    e = a.delegatedEvent(b);
                    e.add("change", "click", l.devts.change);
                    a.custEvent.define(m, ["enable", "disable"]);
                    a.custEvent.add(m, "enable", l.enable);
                    a.custEvent.add(m, "disable", l.disable)
                },initPlugins: function() {
                    f = a.ui.mod.layer(k.scanSucc);
                    g = f.getDom("close");
                    a.addEvent(g, "click", f.hide)
                },unbind: function() {
                },devts: {change: function() {
                        if (!c.isLayer) {
                            f && f.hide();
                            l.getQRcode()
                        } else {
                            l.getQRcode();
                            d.qrcode_err.style.display = "none"
                        }
                    }},handle: {getQRcode_success: function(a) {
                        d.qrcode_src.src = a.data.image;
                        if (!c.isLayer)
                            f && f.hide();
                        else {
                            d.qrcode_err.style.display = "none";
                            d.qrcode_succ.style.display = "none"
                        }
                    },qrcode_scanned: function(e) {
                        if (!c.isLayer) {
                            var g = f.getDom("outer"), h = a.core.dom.position(b);
                    ...
                    d.qrcode_src.src ? i.fire("start") : l.getQRcode()
                },disable: function() {
                    i.fire("cancel")
                },tips: {show: function() {
                        ...
                        d.icon_ask.style.display = "none"
                    }},destroy: function() {
                    e && e.destroy && e.destroy()
                }}, m = {enable: l.enable,disable: l.disable};
            l.init();
            return m
        }
    });
    STK.register("v6.pub.login.desktop", function(a) {
        var b = a.kit.extra.language, c = a.core.util.templet, d = {FRAME: '<div class="B_login form_login_register mt_20"><div class="item S_txt2 W_tc">已登录微博，点击头像直接进入</div><div node-type="logged_loading" style="display:none" class="module_loading"><span class="W_loading_big"></span><span class="W_f14 S_txt2" style="display:none">系统繁忙，<a href="">点击重试</a></span></div><div class="W_tips tips_warn clearfix" node-type="logged_tip" style="display:none" ><p class="icon"><span class="W_icon icon_warnS"></span></p><p class="txt">为了您的安全，请确认登录</p><p class="close"><a class="W_ficon ficon_close S_ficon" href="#">X</a></p></div><div node-type="logged_acc_show" class="item avatar_login clearfix"><div class="scroll_wrap clearfix"><div node-type="logged_userlist" class="acc_wrap"></div><a node-type="arrow" action-type="left" style="display:none" href="jsvascript:void(0);" class="page_btn btn_prev"><span class="W_ficon ficon_arrow_left S_ficon">b</span></a><a node-type="arrow" action-type="right" style="display:none" href="jsvascript:void(0);" class="page_btn btn_next"><span class="W_ficon ficon_arrow_left S_ficon">a</span></a></div></div><div class="item_btn"><a class="W_btn_b btn_34px" href="javascript:void(0);" action-type="backToNormal" action-data="from=desktop_form">换个账号登录</a></div><div class="other_info W_tr"><a href="https://passport.weibo.com/othersitebind/authorize?entry=miniblog&site=qq" class="S_txt1" target="_blank"><span class="icon_qq"></span><span>QQ登录</span></a></div></div>',USER: '<div class="avatar_acc W_tc"><a action-type="login" action-data="uid=#{UID}" href="jsvascript:void(0);" class="avatar_wrap"><img width="82" height="82" class="W_face_radius" src="#{AVATOR}"></a><a action-type="login" action-data="uid=#{UID}" href="jsvascript:void(0);" class="name W_autocut S_txt1">#{NICKNAME}</a></div>',TIP: b('<div class="W_f14 S_txt2">#{MSG}</div>')};
        return function(b, e) {
            var f = a.v6.conf.channel.sso.desktop, g = !1, h, i, j = {small_acc_width: 75,current_acc: 0,on_scroll: !1,play_duration: 120}, k = ["loading", "tip", "acc_show"], l = !1, m = 0, n = function() {
                m++;
                return m > 5 ? !0 : !1
            }, o = {init: function() {
                    o.parseParam();
                    ...
                    e = e || {};
                    d = a.core.obj.parseParam(d, e.TEMP)
                },bind: function() {
                    i = a.core.evt.delegatedEvent(b);
                    for (var c in o.domEvts)
                        i.add(c, "click", o.domEvts[c]);
                    a.custEvent.define(p, ["desktop", "refresh"]);
                    for (var c in o.castEvts)
                        a.custEvent.add(p, c, o.castEvts[c]);
                    for (var c in o.handle)
                        f.register(c, o.handle[c])
                },handle: {getuserinfo_ready: function(b) {
                        if (b.code == 0) {
                            h = b.data;
                            o.render();
                            if (!l) {
                                a.custEvent.fire(p, "desktop", 1);
                                l = !0
                            }
                        } else
                            a.custEvent.fire(p, "desktop", 0)
                        ...
                        a.custEvent.fire(p, "desktop", 0)
                    }},domEvts: {back: function(b) {
                        a.preventDefault(b.evt);
                        o.back()
                    },login: function(b) {
                        a.preventDefault(b.evt);
                        o.access("loading");
                        f.fire("login", b.data.uid)
                    },left: function(b) {
                        a.preventDefault(b.evt);
                        if (!j.on_scroll) {
                            j.on_scroll = !0;
                            j.current_acc >= 2 ? j.current_acc -= 2 : j.current_acc--;
                            a.core.ani.tween(nodes.logged_userlist, {duration: j.play_duration,end: function() {
                                    a.setStyle(nodes.arrow[1], "display", "");
                                    j.current_acc <= 0 && a.setStyle(nodes.arrow[0], "display", "none");
                                    j.on_scroll = !1
                                }}).finish({marginLeft: j.current_acc * j.small_acc_width * -1})
                        }
                    },right: function(b) {
                        a.preventDefault(b.evt);
                        if (!j.on_scroll) {
                            j.on_scroll = !0;
                            h.length - 3 - j.current_acc >= 2 ? j.current_acc += 2 : j.current_acc++;
                            a.core.ani.tween(nodes.logged_userlist, {duration: j.play_duration,end: function() {
                                    a.setStyle(nodes.arrow[0], "display", "");
                                    h.length - j.current_acc <= 3 && a.setStyle(nodes.arrow[1], "display", "none");
                                    j.on_scroll = !1
                                }}).finish({marginLeft: j.current_acc * j.small_acc_width * -1})
                        }
                    }},access: function(b) {
                    if (!!a.inArray(b, k))
                        for (var c in k)
                            a.setStyle(nodes["logged_" + k[c]], "display", b == k[c] ? "" : "none")
                },castEvts: {refresh: function() {
                        o.refresh()
                    }},refresh: function() {
                    o.access("loading");
                    o.scan()
                    ...
                    a.hasClassName(nodes.logged_acc_show, "logged_acc_show") || a.addClassName(nodes.logged_acc_show, "logged_acc_show");
                    nodes.arrow && a.setStyles(nodes.arrow, "display", "none");
                    var e = "avator";
                    switch (h.length) {
                        case 1:
                            e = "avator_middle";
                    ...
                    var f = [];
                    for (var g in h)
                        f.push(c(d.USER, {NICKNAME: h[g].name,AVATOR: h[g][e],UID: h[g].uid}));
                    nodes.logged_userlist.innerHTML = f.join("")
                },scan: function() {
                    f.fire("init")
                }}, p = {};
            p.destroy = function() {
                for (var b in o.domEvts)
                    i.remove(b, "click", o.domEvts[b]);
                for (var b in o.castEvts)
                    a.custEvent.remove(p, b, o.castEvts[b]);
                a.custEvent.undefine(p, ["desktop", "refresh"]);
                for (var b in o.handle)
                    f.remove(b, o.handle[b]);
                i.destroy();
                i = undefined
            };
            o.init();
    ...
    STK.register("common.setting.mobile", function(a) {
        var b = {E01: "",E02: "#L{目前支持大陆、港澳台手机号注册}",E03: "#L{请输入手机号码}",E04: "#L{手机号长度11位，以13/14/15/17/18开头}"};
        return function(c, d) {
            var e = function() {
                var a = g.value(), b = !1;
                if (!g.pars.must && g.rule.isEmpty(a)) {
                        ...
                        if (g.pars.iodelay === 0 && !g.pars.proxy && !g.pars.iokey) {
                            ...
                            ioDelay = setTimeout(function() {
                                ...
                                if (g.msg.state && g.pars.proxy && g.pars.iokey) {
                                    g.msg.type = "loading";
                                    g.pars.iorecords = !0;
                                    g.pars.proxy.request(g.pars.iokey, {onSuccess: function(b) {
    ...
    STK.register("common.setting.activation", function(a) {
        var b = {E01: "",E02: "#L{请输入短信激活码}",E03: "#L{激活码输入有误}"};
        return function(c, d) {
            var e = function() {
                var a = g.value().replace(/^\s+|\s+$/g, ""), b = !1;
                if (!g.pars.must && g.rule.isEmpty(a)) {
    ...
    STK.register("v6.pub.form.timer", function(a) {
        ...
        return function(c, d) {
            var e = {}, f, g, h = {init: function() {
                    f = a.parseParam({time: 0,loop: "ss"}, c);
                    d = d || function() {
                    }
                },start: function() {
                    var a = f.time, c = function() {
                        d({last: a,dd: Math.floor(a / b.dd),hh: Math.floor(a % b.dd / b.hh),mm: Math.floor(a % b.dd % b.hh / b.mm),ss: a % b.mm});
                        a == 0 && clearInterval(g);
                        a -= b[f.loop]
                    };
    ...
    STK.register("v6.conf.trans.sso.message", function(a) {
        var b = a.v6.lib.kit.io.inter(), c = b.register;
    ...
    STK.register("v6.pub.login.message", function(a) {
        ...
        return function(i, k) {
            var l, m, n, o, p, q, r = {}, s = {unChecked: !1}, t = null, u = {init: function() {
                    u.parseParam();
                    u.initPlugins();
                    u.bind()
                },parseParam: function() {
                    ...
                    }},errTip: {show: function(a, b) {
                        for (var c in a)
                            if (!a[c].state) {
                                var d = "" + a[c].msg, e = a[c].offsetX;
                                c == "username" && (c = "mobile");
                                if (c == "mobile")
                                    switch (a[c].code) {
                                        case "E04":
                                ...
                                setTimeout(function() {
                                    q.show(d, {el: m[c],box: m[c + "_box"],offsetX: e})
                                }, 0);
                                break
                            }
                    },hide: function() {
                    ...
                    if (l.ctls.mobile.msg.state && l.ctls.mobile.msg.type == "ok") {
                        ...
                        p = a.v6.pub.form.timer({time: 59}, function(a) {
                        ...
                        p.start();
                        e.getTrans("send_sms", {onComplete: function(a) {
                                var b = {activation: {state: !1,msg: a.msg}};
                                if (a.retcode == 2e7) {
                                    b = {activation: {state: !1,msg: g.TIPS.SEND_SMS_SUCCESS,offsetX: -18}};
                                    v.errTip.show(b)
                                } else {
                                    if (a.retcode == 50110801) {
                                        b = {mobile: {state: !1,msg: g.TIPS.MOBILE_NOT_REGISTER}};
                                        p.stop()
                                    }
                                    if (a.retcode == 50110810 || a.retcode == 50110811)
                                        b = {activation: {state: !1,msg: g.TIPS.SEND_SMS_TOOFAST,offsetX: -18}};
                                    v.errTip.show(b)
                                }
                        ...
                        v.errTip.show({mobile: l.ctls.mobile.msg}, 1);
                    typeof t == "function" && (t = null)
                },destroy: function() {
                    v.stopCheckUsername();
                    v.errTip.hide();
                    ...
                    }},verify: {complete: function(b) {
                        v.unlock();
                        b.smsurl && (s.unChecked = a.core.util.URL(b.smsurl).getParam("s"));
                        typeof t == "function" && (s.unChecked ? t() : v.errTip.show({activation: {state: !1,msg: g.TIPS.SEND_SMS_ERROR}}))
                    },update: function(a) {
                    },failure: function(a) {
                        m[a].value = ""
                    }}}, x = {destroy: u.destroy};
    ...
    STK.register("v6.pub.dialog.login", function(a) {
        var b = {DIALOG_FRAME: '<div class="Bv6_layer" node-type="outer"><div class="content" node-type="layoutContent"><div node-type="title" class="W_layer_title" style="cursor: move;"></div><div class="W_layer_close"><a node-type="close" href="javascript:void(0);" class="W_ficon ficon_close S_ficon">X</a></div><div class="layer_login_register clearfix" node-type="inner"> </div></div></div>',FRAME: '<div class="left"><div class="qrcode" node-type="qrcode_form"><div class="code_wrap"><img alt="" node-type="qrcode_src"><div node-type="qrcode_succ" class="tips" style="display:none"><span class="W_icon icon_succB"></span><div class="tips_txt">#L{扫描成功，点击手机上的确认即可登录}</div></div><div node-type="qrcode_err" class="tips" style="display:none"><span class="W_icon icon_rederrorB"></span><div class="tips_txt">#L{验证码无效！}<a href="javascript:void(0);" action-type="change">#L{手动更换}</a></div></div><div class="Bv6_layer Bv6_layer_pop" node-type="icon_ask"><div class="content"><img src="http://img.t.sinajs.cn/t6/style/images/growth/qrcode_map.jpg?version=201308271649"><div class="W_layer_arrow"><span class="W_arrow_bor W_arrow_bor_l"><i class="S_line3"></i><em class="S_bg2_br"></em></span></div></div> </div></div><div class="note S_txt1">#L{用微博手机版扫描安全登录}</div></div></div><div class="right"><div class="tab_bar"><a href="javascript:void(0);" node-type="login_tab" action-type="switch" action-data="tabname=login" class="cur">#L{登录}</a><a href="javascript:void(0);" node-type="register_tab" action-type="switch" action-data="tabname=register">#L{注册}</a></div><div node-type="login_frame"><div class="logged_loading" node-type="module_loading" style="display: none;"><span class="W_loading_big" style="display:"></span><span class="W_f14 S_txt2" style="display:none">#L{系统繁忙，}<a href="">#L{点击重试}</a></span></div><div class="B_login form_login_register mt_30" node-type="loginForm" style="display: none;"><a href="javascript:void(0);" node-type="btn_back" action-type="btn_back" class="item login_back S_txt1" style="display:none"><em class="W_ficon ficon_back">«</em>#L{返回}</a><div node-type="prename_box"></div><div class="item username input_wrap" node-type="username_box"><input autocomplete="off" maxlength="128" tabindex="1" node-type="username" name="username" type="text" class="W_input" action-type="text_copy" action-data="text=#L{邮箱/会员帐号/手机号}" value="" /></div><div class="item password input_wrap" node-type="password_box"><input maxlength="24" tabindex="2" node-type="password" name="password" type="password" class="W_input" action-type="text_copy" value="" /><span class="enter_psw">#L{请输入密码}</span></div><div class="item weidun" style="display: none" node-type="vsncode_box"><input maxlength="6" tabindex="4" node-type="vsncode" name="vsncode" type="text" class="W_input" value="" action-type="text_copy" action-data="text=#L{请输入微盾动态码}"><a href="http://account.weibo.com/forgot/vdun" node-type="btn_vsncode_recover" class="S_txt1">微盾挂失</a></div><div class="item verify" style="display: none" node-type="verifycode_box"><input maxlength="6" tabindex="3" node-type="verifycode" name="verifycode" type="text" class="W_input" value="" action-type="text_copy" action-data="text=#L{验证码}"><a class="code" href="javascript:void(0);"><img node-type="verifycode_image" action-type="btn_change_verifycode" width="100" height="40" alt="" src=""></a><a node-type="btn_change_verifycode" action-type="btn_change_verifycode" href="javascript:void(0);" class="S_txt1">换一张</a></div><div class="item auto_login"><input type="checkbox" tabindex="5" id="login_form_savestate" checked="checked" node-type="savestate" type="checkbox"><label for="login_form_savestate" class="S_txt2">#L{下次自动登录}</label></div><div class="item_btn"><a class="W_btn_a btn_34px" tabindex="6" suda-data="key=tblog_weibologin3&value=click_sign" node-type="submitBtn" action-type="btn_submit" href="javascript:void(0)"><em>#L{登录}</em></a></div><div class="item_btn login_qq" node-type="qq_box"><a target="_blank" class="W_btn_b btn_34px" href="https://passport.weibo.com/othersitebind/authorize?entry=miniblog&site=qq"><i class="icon_qq"></i><em>#L{使用QQ直接登录}</em></a></div><div class="other_info W_tr"><a class="S_txt1" suda-data="key=tblog_weibologin3&value=click_forgetpwd" target="_blank" node-type="btn_password_recover" href="https://login.sina.com.cn/getpass.html?entry=weibo">#L{忘记密码}</a><a href="javascript:void(0);" node-type="btn_message_login" action-type="btn_message_login" class="S_txt1">#L{短信登录}</a></div></div><div class="B_login form_login_register mt_20" node-type="message_form" style="display: none;"><a href="javascript:void(0);" class="item login_back S_txt1" action-type="backToNormal" action-data="from=message_form"><em class="W_ficon ficon_back">«</em>#L{返回用户名密码登录}</a><div class="item phone input_wrap" node-type="mobile_box"><input type="text" class="W_input" autocomplete="off" value="" name="username" action-type="text_copy" action-data="text=#L{请输入您的手机号码}" node-type="mobile" no_cls="true"></div><div class="item msg_code"><a class="W_btn_b S_txt1" action-data="type=sendsms" node-type="btn_sms_activation" action-type="btn_sms_activation" href="javascript:void(0);">#L{获取短信验证码}</a><a node-type="btn_sms_activation_disable" href="javascript:void(0);" class="W_btn_b W_btn_b_disable" style="display:none"><em node-type="sms_timer">180</em>#L{秒后再获取短信}</a><input action-type="text_copy" class="W_input" type="text" action-data="text=#L{短信验证码}" maxlength="6" autocomplete="off" value="#L{短信验证码}" name="password" node-type="activation"></div><div class="item auto_login"><input type="checkbox" tabindex="5" id="login_form_savestate" checked="checked" node-type="savestate"><label for="login_form_savestate" class="S_txt2">#L{下次自动登录}</label></div><div class="item_btn"><a tabindex="6" suda-data="key=tblog_weibologin3&value=click_sign" node-type="submitBtn" action-type="btn_submit" class="W_btn_a btn_34px" href="javascript:void(0)"><em>#L{登录}</em></a></div><div class="item_btn login_qq"><a target="_blank" class="W_btn_b btn_34px" href="https://passport.weibo.com/othersitebind/authorize?entry=miniblog&site=qq"><i class="icon_qq"></i><em>#L{使用QQ直接登录}</em></a></div></div><div class="B_login form_login_register mt_20" node-type="desktop_form" style="display: none;"></div></div><div node-type="register_frame" style="display:none;"></div> </div> ',MESSAGE_LOGIN_LINK: '<p class="info W_tr"><a href="http://weibo.com/#type=message" target="_blank">#L{短信验证码登录}</a></p>'}, c = window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com", d = a.v6.conf.core.ui.dialog({template: b.DIALOG_FRAME,isHold: !0}), e = d.getDomList().inner;
        return function(f) {
            var g, h, i = null, j = null, k, l, m, n, o, p, q, r = {init: function() {
                    r.parseParam();
                    r.initPlugin();
                    r.show();
                    r.bind()
                    ...
                    f = f || {};
                    o = "http://" + c + "/signup/mobile.php?entry=quicklayerv6&backurl=" + encodeURIComponent(window.location.href);
                    f.opener && (o += "&opener=" + f.opener);
                    r.is.visitor() && (o += "&vid=3655689037")
                },show: function() {
                    d.setContent(a.core.util.templet(b.FRAME, {MESSAGE_LOGIN_LINK: r.is.visitor() ? "" : b.MESSAGE_LOGIN_LINK}) + r.extdata());
                    g = a.kit.dom.parseDOM(a.builder(e).list);
                    l = a.v6.pub.login.qrcode(g.qrcode_form, {isLayer: !0});
                    l.enable();
                    a.custEvent.add(d, "hide", function() {
                        l.disable()
                    });
                    d.show();
                    a.setStyle(g.module_loading, "display", "");
                    if (/win64;\sx64;/i.test(navigator.userAgent.toLowerCase())) {
                        a.setStyle(g.module_loading, "display", "none");
                        a.setStyle(g.loginForm, "display", "");
                        if (f.currentTab == "register" || r.is.visitor() && f.currentTab != "login") {
                            k = "login";
                            r.handle.change("register")
                        } else {
                            k = "register";
                            r.handle.change("login")
                        }
                    } else {
                        m = a.v6.pub.login.desktop(g.desktop_form);
                        a.custEvent.add(m, "desktop", function(b, c) {
                            a.setStyle(g.module_loading, "display", "none");
                            if (c) {
                                a.setStyle(g.loginForm, "display", "none");
                                a.setStyle(g.desktop_form, "display", "");
                                k = "register";
                                r.handle.change("login")
                            } else {
                                a.setStyle(g.loginForm, "display", "");
                                a.setStyle(g.desktop_form, "display", "none");
                                if (f.currentTab == "register" || r.is.visitor() && f.currentTab != "login") {
                                    k = "login";
                                    r.handle.change("register")
                                } else {
                    ...
                    h = a.delegatedEvent(e);
                    for (var b in r.domEvts)
                        h.add(b, "click", r.domEvts[b]);
                    a.custEvent.add(d, "hide", function() {
                        i && i.destroy();
                        h.remove("switch", "click", r.domEvts.change);
                        h.destroy();
                        q && q.destroy();
                        m.destroy();
                        n && n.destroy();
                ...
                },domEvts: {"switch": function(b) {
                        a.preventDefault(b.evt);
                        r.handle.change(b.data.tabname)
                    },changeTab: function() {
                        var a = arguments[2];
                        r.handle.change(a)
                    },backToNormal: function(b) {
                        a.preventDefault(b.evt);
                        var c = b.data.from && b.data.from.split("_");
                        g["btn_" + c[0] + "_login"] && a.setStyle(g["btn_" + c[0] + "_login"], "display", "");
                        if (c[0] != "message") {
                            a.setStyle(g.btn_back, "display", "");
                            p = b.data.from
                        } else
                            n && a.custEvent.fire(n, "disable");
                        g[b.data.from].style.display = "none";
                        g.loginForm.style.display = "";
                        r.handle.loginForm()
                    },btn_back: function(b) {
                        a.preventDefault(b.evt);
                        i && a.custEvent.fire(i, "closeTip");
                        g[p].style.display = "";
                        g.loginForm.style.display = "none"
                    },btn_message_login: function(b) {
                        a.preventDefault(b.evt);
                        i && a.custEvent.fire(i, "closeTip");
                        a.setStyle(g.btn_message_login, "display", "none");
                        g.message_form.style.display = "";
                        g.loginForm.style.display = "none";
                        i && i.destroy();
                        i = null;
                        !n && (n = a.v6.pub.login.message(g.message_form))
                    },closeTip: function(b) {
                        a.preventDefault(b.evt);
                        var c = a.fixEvent(b.evt).target;
                        c.tagName.toLowerCase() == "a" && (b.el.style.display = "none")
                    }},handle: {otherForm: function() {
                        a.kit.io.jsonp({url: "http://" + (window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com") + "/a/aj/bind/qlogin",onComplete: function(b) {
                                if (b && b.code == "100000") {
                                    g.otherForm.innerHTML = b.data;
                                    a.setStyle(g.otherForm, "display", "")
                                }
                            }}).request()
                        ...
                        n && a.custEvent.fire(n, "disable");
                        if (!j) {
                            g.register_frame.innerHTML = '<iframe name="register_layer_iframe" class="item_register_frame" frameborder="0" scrolling="no" _src="' + o + '" ></iframe>';
                            if (!q) {
                                q = a.v6.pub.third.iframe(a.core.dom.firstChild(g.register_frame));
                                q.on("changeTab", r.domEvts.changeTab)
                            }
                            j = 1
                        }
                    },loginForm: function() {
                        j && r.handle.loginFocus();
                        i || (i = a.v6.pub.login.form(g.loginForm))
                    },loginFocus: function() {
                        ...
                        a.core.dom.insertElement(e, b.box);
                        ...
                        if (k !== b) {
                            a.removeClassName(g[k + "_tab"], "cur");
                            a.setStyle(g[k + "_frame"], "display", "none");
                            a.addClassName(g[b + "_tab"], "cur");
                            a.setStyle(g[b + "_frame"], "display", "");
                            setTimeout(function() {
                                r.handle[b + "Form"]();
                                k = b;
                                d.setMiddle()
                    ...
                    var b = '<img src="http://rs.sinajs.cn/xdht.gif?lglayer=show&_rnd=' + (new Date).getTime(), c = a.URL(decodeURI(window.location.href)).getParam("c");
                    c && (b = b + "&c=" + encodeURIComponent(c));
                    r.is.visitor() ? b = b + "&visitor=1" : b = b + "&visitor=0";
                    b = b + '" />';
                    return b
                }};
            r.init();
    ...
    STK.register("v6.pl.open.loginlayer.source.main", function(a) {
        ...
        return function(d) {
            ...
            e.parseParam = function() {
                d = a.core.obj.parseParam({lang: "zh-cn",opener: "",currentTab: ""}, d || {})
            };
            e.init = function() {
                e.parseParam();
                e.getVersion()
            ...
            e.getVersion = function() {
                ...
                if (b) {
                    ...
                    a.v6.lib.kit.io.jsonp({url: "http://" + (window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com") + "/signup/v5/getjsversion",onComplete: function(a) {
            ...
            e.getVersionHandle = function() {
                ...
                e.loadCss();
                a.cookie.set("WBtopGlobal_register_version", d.version, {encode: !1})
            };
            e.loadCss = function() {
                b ? e.loadLanguage() : a.v6.lib.kit.io.cssLoader(a.v6.lib.kit.extra.cssPath().replace("t4", "t6").replace("t5", "t6") + "style/css/module/growth/layer_login_register.css?version=" + d.version, "js_style_css_module_growth_layer_login_register", function() {
                    b = !0;
                    e.loadLanguage()
                })
            };
            e.loadLanguage = function() {
                !c && d.lang != "zh-cn" ? a.core.io.scriptLoader({timeout: 1e3,url: a.v6.lib.kit.extra.jsPath().replace("t4", "t5") + "lang/jsloginlayer/mo/" + d.lang + ".js?version=" + d.version,onComplete: function() {
                        c = !0;
                        e.showlayer()
                    },onTimeout: e.showlayer}) : e.showlayer()
            };
    ...
    return function(b) {
        ssoConf = a.core.obj.parseParam({feedBackUrl: "",loginSuccessUrl: encodeURIComponent(window.location.href)}, b || {});
        ssoConf.loginSuccessUrl = "http://" + (window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com") + "/login.php?url=" + (decodeURIComponent(ssoConf.loginSuccessUrl) == ssoConf.loginSuccessUrl ? encodeURIComponent(ssoConf.loginSuccessUrl) : ssoConf.loginSuccessUrl) + "&comefrom=loginlayer";
        var c = {plugins: {desktop: !0,login: !0,qrcode: !0},loginParam: ssoConf};
