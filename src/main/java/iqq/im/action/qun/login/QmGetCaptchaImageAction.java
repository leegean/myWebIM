...
public class QmGetCaptchaImageAction extends AbstractHttpAction {
	 ...
	 * @param uin a long.
	 */
	public QmGetCaptchaImageAction(QQContext context, QQActionListener listener, long uin) {
	...
	protected QQHttpRequest onBuildRequest() throws QQException, JSONException {
		String url = StringHelper.format(QQConstants.URL_QM_GET_CAPTCHA, uin, QQConstants.APPID, Math.random());
