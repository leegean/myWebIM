 ...
 * @author solosky
 */
public class QmGetCaptchaImageAction extends AbstractHttpAction {
	/**
	 ...
	 * @param uin a long.
	 */
	public QmGetCaptchaImageAction(QQContext context, QQActionListener listener) {
	...
	protected QQHttpRequest onBuildRequest() throws QQException, JSONException {
		String url = StringHelper.format(QQConstants.URL_QM_GET_CAPTCHA, getContext().getAccount().getUin(), QQConstants.QM_APPID, Math.random());
